...
percent fuzz::token_ratio(const boost::wstring_view& s1, const boost::wstring_view& s2, percent score_cutoff)
{
    if (score_cutoff > 100) {
        return 0;
    }
...
percent fuzz::WRatio(const boost::wstring_view& s1, const boost::wstring_view& s2, percent score_cutoff)
{
    if (score_cutoff > 100) {
        return 0;
    }
